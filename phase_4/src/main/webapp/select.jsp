...
<body>
		...
		if(number.equals("1")){
			...
			out.println("Academy Worker의 연봉이 <input type='text' name='salary1'> 이상인 경우 찾기 ");
			// 몇 줄 긁어올지 결정하는 load
		}
		else if(number.equals("2")){
			out.println("<input type='hidden' name='number' value='2'>");
			out.println("<h2>Query 2. Academy Worker 평균 연봉 탐색 </h2>");
			out.println("다음 Institute에 속한 Academy의 평균 연봉 ");
			...
			out.println("<input type='hidden' name='number' value='3'>");
			out.println("<h2>Query 3. 논문의 공개 범위 검색 </h2>");
			out.println("<select name='opento'>");
			out.println("<option value='public'>Public</option>");
			out.println("<option value='subscriber only'>Subscriber only</option>");
			out.println("</select>");
		}
		else if(number.equals("4")){
			out.println("<input type='hidden' name='number' value='4'>");
			out.println("<h2>Query 4. 논문의 키워드로 검색  </h2>");
			out.println("다음의 논문번호와 같은 키워드가 한 개 이상의 논문 찾기 ");
			out.println("<input type='text' name='jid1'>");
		}
		else if(number.equals("5")){
			out.println("<input type='hidden' name='number' value='5'>");
			out.println("<h2>Query 5. 조회수로 논문 검색 </h2>");
			out.println("조회수가 <select name='views'>");
			...
			out.println("</select> 이상인 경우 ");
		}
		else if(number.equals("6")){
			out.println("<input type='hidden' name='number' value='6'>");
			out.println("<h2>Query 6. 다음의 조건에 부합하는 구독자 검색 </h2>");
			out.println("평가 별 개수가 ");
			...
			out.println("</select>");
			out.println("개인 구독자  <br>");
		}
		else if(number.equals("7")){
			out.println("<input type='hidden' name='number' value='7'>");
			out.println("<h2>Query 7. Academy 이름으로 검색 </h2>");
			out.println("Academy 이름에  ");
			out.println("<input type='text' name='academyname'>");
			out.println(" 가 들어간 경우 ");
		}
		else if(number.equals("8")){
			out.println("<input type='hidden' name='number' value='8'>");
			out.println("<h2>Query 8. Institute 검색  </h2>");
			out.println("구독한 날짜가 ");
			...
			out.println("<input type='hidden' name='number' value='9'>");
			out.println("<h2>Query 9. 두 가지 키워드로 논문 검색하기 </h2>");
			out.println(" 키워드 1 ");
