<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR" %>
    ...
    <%@ page language="java" import="java.text.*, java.sql.*" %>
        ...
        <body>
            <% String serverIP="localhost" ; String strSID="xe" ; String portNum="1521" ; String user="dbms" ; String
                pass="1212" ; String url="jdbc:oracle:thin:@" +serverIP+":"+portNum+":"+strSID; /*
                System.out.println(url); */ Connection conn=null; PreparedStatement pstmt; ResultSet rs;
                Class.forName("oracle.jdbc.driver.OracleDriver"); conn=DriverManager.getConnection(url,user,pass);
                String sql="" ; /* System.out.println(query); */ %>
                <h4>-------- Result ---------</h4>
                <% String number=request.getParameter("number"); switch(number){ case "1" : String
                    salary1=request.getParameter("salary1");
                    sql="select f_name, l_name, salary from academyworker where salary > " + salary1;
                    pstmt=conn.prepareStatement(sql); rs=pstmt.executeQuery(); out.println("<table border=\"1\">");
                    ...
                    for(int i =1;i<=cnt;i++){ out.println("<th>"+rsmd.getColumnName(i)+"</th>");
                        ...
                        sql = "select a.academy_name, round(AVG(aw.salary),2) as average_sal from academyworker aw inner
                        join academy a \r\n"
